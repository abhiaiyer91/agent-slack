...
export class HandoffManager {
    _handoffs = new Map();
    _bySender = new Map();
    _byRecipient = new Map();
    _pendingByCapability = new Map();
    /**
     ...
     */
    getPendingForCapability(capability) {
     ...
     * Reject a handoff.
     */
    reject(handoffId, agentId, reason = '') {
        const handoff = this.get(handoffId);
        if (!handoff || handoff.status !== HandoffStatus.PENDING) {
            return undefined;
        }
