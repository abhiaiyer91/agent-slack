 ...
 */
export function createWorkspaceAgent(workspace, config) {
 ...
 */
export function createAgentTeam(workspace, roles) {
    const team = new Map();
 ...
 */
export const Teams = {
    codeReview: ['codeReviewer', 'securityAnalyst', 'techWriter'],
    fullStack: ['codeReviewer', 'securityAnalyst', 'qaEngineer', 'devOps'],
    research: ['researcher', 'techWriter', 'projectLead'],
    incident: ['devOps', 'securityAnalyst', 'projectLead'],
};
